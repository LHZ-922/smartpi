...
apt-get -y update
apt -y install curl
wget https://github.com/pymumu/smartdns/releases/download/Release47.1/smartdns.1.2025.11.09-1443.x86_64-linux-all.tar.gz
tar zxf smartdns.1.2025.11.09-1443.x86_64-linux-all.tar.gz
cd smartdns
chmod +x ./install
./install -i
